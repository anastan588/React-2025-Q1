...
export function FlyoutElement() {
  ...
  return (
    <div className="bg-third max-sm:top-0.7 max-sm:right-0.7 fixed top-5 right-7 flex flex-col items-center gap-4 rounded-lg border border-white p-4 text-white max-xl:top-4 max-xl:right-5 max-xl:p-3 max-lg:top-2 max-lg:right-2 max-lg:p-1 max-sm:p-1">
